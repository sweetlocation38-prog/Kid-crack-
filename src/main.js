...
const CONTINENTS = [
  {
    competence: 'lecture',
    zone: { left: 0.5, top: 0.515, width: 0.5, height: 0.34 },
    labelCourt: 'Lecture',
  ...
  {
    competence: 'maths',
    zone: { left: 0.5, top: 0.284, width: 0.5, height: 0.343 },
    labelCourt: 'Maths',
  ...
  {
    competence: 'logique',
    zone: { left: 0.0, top: 0.515, width: 0.5, height: 0.34 },
    labelCourt: 'Logique',
    paysSlotsFor: { 'jeu_intrus': { top: '52%', left: '17%' }, 'empreintes_clairiere': { top: '52%', left: '83%' }, 'puzzle_moulin': { top: '74%', left: '17%' }, 'tri_village': { top: '74%', left: '83%' }, 'labyrinthe_grotte': { top: '92%', left: '50%' } },
    paysVides: [],
  ...
  {
    competence: 'memoire',
    zone: { left: 0.5, top: 0.0, width: 0.5, height: 0.3195 },
    labelCourt: 'Mémoire',
    paysSlotsFor: { 'memoire_etoiles': { top: '78%', left: '25%' }, 'coffre_souvenirs': { top: '78%', left: '75%' }, 'ronde_lucioles': { top: '92%', left: '50%' } },
  ...
  },
  {
    ...
    zone: { left: 0.0, top: 0.0, width: 0.5, height: 0.349 },
  ...
  {
    competence: 'histoire',
    zone: { left: 0.12, top: 0.7337, width: 0.66, height: 0.2663 },
    labelCourt: 'Histoire',
    paysSlotsFor: { 'frise_temps': { top: '80%', left: '78%' } },
    paysVides: [],
  ...
  {
    competence: 'sciences',
    zone: { left: 0.0, top: 0.2544, width: 0.5, height: 0.3728 },
    labelCourt: 'Sciences',
    paysSlotsFor: { 'corps_humain': { top: '58%', left: '35%' } },
    paysVides: [{ top: '80%', left: '50%' }, { top: '25%', left: '22%' }, { top: '25%', left: '75%' }],
